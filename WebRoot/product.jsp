...
<div id="wrapper">
    ...
    <li><img src="images/logo.jpg" id="logoImg"></li>
      ...
      <li><a href="indexAction!productListPage.action" id="menu_selected" title="产品中心"><span>产品中心</span></a></li>
...
<!-- js图片和图片得文字说明 -->
  ...
  <div id="page_main" class="clearfix">
    <div class="page-right">
      <div class="site-nav"><span>当前位置 : </span><a href=".">公司主页</a> &gt;&gt; <a href="indexAction!productListPage.action" title="产品展示">产品展示</a>&gt;&gt;产品介绍</div>
